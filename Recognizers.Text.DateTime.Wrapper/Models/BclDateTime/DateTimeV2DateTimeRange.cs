...
namespace Recognizers.Text.DateTime.Wrapper.Models.BclDateTime
{
    ...
    /// </summary>
    class DateTimeV2DateTimeRange : DateTimeV2ObjectWithValue<ComparableRange<System.DateTime>>
    {
        ...
        {
            if (!System.DateTime.TryParseExact(value["start"], "uuuu-MM-dd HH:mm:ss", null, default, out System.DateTime start))
            {
                throw new ArgumentException($"{value["start"]} is not of the format uuuu-MM-dd HH:mm:ss");
            }

            if (!System.DateTime.TryParseExact(value["end"], "uuuu-MM-dd HH:mm:ss", null, default, out System.DateTime end))
            {
